...
- [Usage](#usage)
  - [Loading Raw FLIM Data](#loading-raw-flim-data)
    - [Input Data Types](#1-input-data-types)
    - [Opening a Raw FLIM Image](#opening-a-raw-flim-image)
    - [Loading Stacks](#loading-stacks)
    - [Sample Data](#sample-data)
  - [Phasor Analysis](#phasor-analysis)
    - [Generating Phasor Plots](#generating-phasor-plots)
    - [Phasor Plot Navigation](#phasor-plot-navigation)
    - [Phasor Plot Selection](#phasor-plot-selection)
    - [Integrating Phasor Analysis into a Workflow](#integrating-phasor-analysis-into-a-workflow)
